...
(function() {
  ...
  this.ColorCanvas.Canvas = (function(_super) {
...
(function() {
  ...
  this.ColorCanvas.Alpha = (function(_super) {
...
(function() {
  ...
  this.ColorCanvas.Gradient = (function(_super) {
...
(function() {
  ...
  this.ColorCanvas.Spectrum = (function(_super) {
...
(function() {
  ...
  this.ColorCanvas.Picker = (function(_super) {
    ...
    Picker.prototype.className = 'colorPicker';
    ...
    Picker.prototype.save = function(e) {
      e.preventDefault();
      this.close();
