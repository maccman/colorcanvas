  ...
  this.ColorCanvas.Color = (function() {
    ...
    Color.prototype.set = function(r, g, b, a) {
      ...
      if (typeof r === 'object') {
        ...
        this.g = g != null ? g : this.g;
        this.b = b != null ? b : this.b;
...
(function() {
  ...
  ColorCanvas.Gradient = (function(_super) {
    ...
    Gradient.prototype.getCoords = function(color) {
      var h, result, s, v, _ref;
      if (color == null) {
        color = this.color;
      }
      _ref = color.toHSV(), h = _ref[0], s = _ref[1], v = _ref[2];
      return result = {
        left: Math.round(this.width * s),
        top: Math.round(this.height * (1 - v))
      };
    };
...
(function() {
  ...
  ColorCanvas.Spectrum = (function(_super) {
    ...
    Spectrum.prototype.getCoords = function(color) {
      ...
      return result = {
        left: 0,
        top: Math.round(this.height * (1 - h))
      };
    };
  ...
  this.ColorCanvas.Picker = (function(_super) {
    ...
    Picker.prototype.render = function() {
      ...
      this.gradient.bind('change', function(color) {
        var _ref;
        (_ref = _this.color).set.apply(_ref, color.toRGB());
